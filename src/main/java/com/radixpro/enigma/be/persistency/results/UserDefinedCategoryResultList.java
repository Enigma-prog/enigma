 ...
 */
public class UserDefinedCategoryResultList extends AbstractResult {

   private final List<UserDefinedCategory> categories;

   public UserDefinedCategoryResultList(final List<UserDefinedCategory> categories, final DatabaseResults result) {
      super(result);
